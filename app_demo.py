...
BANK_CONFIG = {
    ...
    "ingb4mb7q0": {
        "name": "ING",
        "file": "data/ING_b2_accessibility_scores.xlsx", 
    ...
    "crln9xs3p1": {
        "name": "Crelan",
        "file": "data/ALL_crelan_fr_b2_accessibility_scores.xlsx",
    ...
    def create_login_ui():
        return ui.div(
            ...
            ui.div(
                ...
                ui.div(
                    ui.input_text("access_code", "", placeholder="Demo access code"),
                    style="display: flex; justify-content: center; margin-bottom: 20px;"
                ),

                # Submit button
                ui.input_action_button("login_btn", "View Demo Dashboard", 
        ...
        for bank_code, bank_info in BANK_CONFIG.items():
            try:
                if os.path.exists(bank_info["file"]):
                    ...
                    if 'Compliance Level' in benchmark_df.columns:
                        bank_avg = pd.to_numeric(benchmark_df['Compliance Level'], errors='coerce').mean()
